                    ...
                    <!-- User -->
                      <div class="single-widget-area mb-100">
                          <div class="newsletter-form">
                              ...
                              @if(!Auth::check())
                              <form action="{{route('following',$user['user']->id)}}" method="post" enctype="multipart/form-data">
                                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                                  <input type="hidden" name="userID" value="1">
                                  <button type="submit" class="btn roberto-btn w-100">Follow</button>
                              </form>
                              @elseif(Auth::user()->id != $user['user']->id)
                                  @if($followed)
                                  <form action="{{route('un-following',$user['user']->id)}}" method="post" enctype="multipart/form-data">
                                      <input type="hidden" name="_token" value="{{csrf_token()}}">
                                      <input type="hidden" name="userID" value="1">
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="{{asset('/blog/img/bg-img/40.jpg')}}" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
